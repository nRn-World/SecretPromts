...
export const AuthModal: React.FC = () => {
  ...
  const handleGoogleLogin = async () => {
    ...
    if (result.message !== 'authRedirecting') {
        ...
        <div className="p-6">
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <button
              ...
              className="flex w-full items-center justify-center gap-3 rounded-2xl border border-zinc-800 bg-zinc-950 px-4 py-3 text-xs font-black text-white transition hover:bg-zinc-800 disabled:cursor-not-allowed disabled:opacity-60"
            >
              {isGoogleLoading ? (
