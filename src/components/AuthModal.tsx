      ...
      <div className="w-full max-w-md overflow-hidden rounded-3xl border border-zinc-800 bg-zinc-900 shadow-2xl shadow-purple-950/30">
        ...
        <div className="p-6">
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <button type="button" onClick={loginWithGoogle} className="flex w-full items-center justify-center gap-3 rounded-2xl border border-zinc-800 bg-zinc-950 px-4 py-3 text-xs font-black text-white transition hover:bg-zinc-800">
